...
from A2.Controller import NNController, RandomController
import numpy as np
...
if __name__ == "__main__":
    ...
    best_individual, logbook = evolution_manager.run_evolution(population_size=100, generations=20, cx_prob=0.8, mut_prob=0.2)
