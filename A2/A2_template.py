...
from ariel.simulation.environments import (
    SimpleFlatWorld, AmphitheatreTerrainWorld,
    BoxyRugged, CraterTerrainWorld, PyramidWorld,
    RuggedTerrainWorld, TiltedFlatWorld,
)
...
def random_move(model: mujoco._structs.MjModel, data: mujoco._structs.MjData, to_track) -> None:
