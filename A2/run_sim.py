...
from evolutionNN import Controller, RandomController, NNController

def init_sim(world: Environment):
...
def main( 
    ...
    model, data, to_track = init_sim(world)
    ...
    if visualise:
        ...
        for _ in tqdm(range(simulation_steps)):  # Run for 1000 time steps
